...
$(document).ready(function(){
        ...
        var prev_html = '<img border=0 src="/assets/application/prev_t.png" style="vertical-align:middle">'; //the html inside <a>  for previous news
        var next_html = '<img border=0 src="/assets/application/next_t.png" style="vertical-align:middle">'; //the html inside <a>  for next news
...
function prev_news(){
            ...
            if($('.news_visible').prev('.single_news_container').length){
                ...
                $('.news_visible').fadeTo(100, function(){
                    ...
                    $('.news_visible').removeClass('news_visible').prev('.single_news_container').addClass('news_visible').fadeTo(100); 
...
function next_news(){
            if($('.news_visible').next('.single_news_container').length){
                $('.news_visible').fadeTo(100, function(){
                    $('.news_visible').removeClass('news_visible').next('.single_news_container').addClass('news_visible').fadeTo(100); 
                    var current = parseInt($('#current_news_num').text());
                    $('#current_news_num').text(current + 1);
                });
            }  
